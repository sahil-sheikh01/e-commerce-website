          ...
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className="py-4 border-b border-gray-400 text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4">
                ...
                <input onChange={(e) => Number(e.target.value) > 0 ? updateQuantity(item._id, item.size, Number(e.target.value)) : null} className="border border-gray-400 max-w-10 sm:max-w-20 px-1 sm:px-2 py-1" type="number" min={1} defaultValue={item.quantity} />
